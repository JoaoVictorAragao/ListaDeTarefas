...
window.onload = function() {
	document.getElementById("contrast").style.backgroundColor="#fff";
	...
	document.getElementById("contrast").onmouseout = function()
   	...
   	document.getElementById("increaseFont").style.backgroundColor="#fff";
	...
	document.getElementById("increaseFont").onmouseout = function()
   	...
   	document.getElementById("decreaseFont").style.backgroundColor="#fff";
	...
	document.getElementById("decreaseFont").onmouseout = function()
   	...
   	document.getElementById("teclado").style.backgroundColor="#fff";
	...
	document.getElementById("teclado").onmouseout = function()
   	...
   	document.getElementById("sitemap").style.backgroundColor="#fff";
	...
	document.getElementById("sitemap").onmouseout = function()
   	...
   	document.getElementById("libras").style.backgroundColor="#fff";
        
    document.getElementById("libras").onmouseover = function()
	{
		this.style.backgroundColor = "#333";
	}
	document.getElementById("libras").onmouseout = function()
          {
              this.style.backgroundColor = "#fff";
          }
};
